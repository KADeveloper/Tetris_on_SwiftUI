...
struct Tetromino {
    ...
    var blocks: [BlockLocation] {
        return Tetromino.getBlock(blockType: blockType, rotation: rotation)
    }
    ...
    static func getBlock(blockType: BlockType, rotation: Int = 0) -> [BlockLocation] {
    ...
    static func createNewTetromino(numRows: Int, numColumns: Int) -> Tetromino {
        ...
        var maxRow = 0
        for block in getBlock(blockType: blockType) {
